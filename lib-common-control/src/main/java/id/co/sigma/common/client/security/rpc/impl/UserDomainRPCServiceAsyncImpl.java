...
public class UserDomainRPCServiceAsyncImpl extends ManualJSONSerializeRPCService<UserDomainRPCService> implements UserDomainRPCServiceAsync{
	...
	protected Class<UserDomainRPCService> getServiceInterface() {
		...
		public void getUserDomainFromIIS(id.co.sigma.common.data.query.SigmaSimpleQueryFilter[] param0,int param1,int param2,com.google.gwt.user.client.rpc.AsyncCallback<id.co.sigma.common.data.PagedResultHolder<id.co.sigma.common.security.menu.UserDomain>> callback) {
