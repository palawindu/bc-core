...
public final class DualControlUtil implements IDualControlEditorManager{
	 ...
	 **/
	public void submitDataForApproval (DualControlEnabledOperation operation , String remarkOnData , DualControlEnabledData< ?, ?> data , DoubleSubmitProtectedAsyncCallback<SimpleMasterDataDualControlApprovalResult> callback) {
	 ...
	 **/
	public void approveData (DualControlEnabledOperation operation ,  CommonDualControlContainerTable data  , DoubleSubmitProtectedAsyncCallback<Void> callback) {
