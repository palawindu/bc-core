...
import id.co.sigma.common.client.dualcontrol.MasterDataUnifiedApprovalMainPanel;
import id.co.sigma.common.client.dualcontrol.MasterDataUnifiedRejectMainPanel;
import id.co.sigma.common.client.security.IMenuHandlerPanelGenerator;
...
public class CommonControlMenuHandler extends MenuHandlerPanelGeneratorGroup{
	...
	private final IMenuHandlerPanelGenerator<?>[] handlers =new IMenuHandlerPanelGenerator<?>[] {
			...
			new IMenuHandlerPanelGenerator<id.co.sigma.common.client.dualcontrol.MasterDataUnifiedApprovalMainPanel>() {
