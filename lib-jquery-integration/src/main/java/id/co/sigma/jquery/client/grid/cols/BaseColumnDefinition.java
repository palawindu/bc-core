...
import id.co.sigma.jquery.client.grid.BaseJQGridPanel;
import id.co.sigma.jquery.client.grid.CustomFormatter;
	...
	* <li>select (this is not a real select but a special case for editing modules. See note below)</li>
	...
	protected native JavaScriptObject buildNativeFormatterWrapper (CustomFormatter<DATA> actualFormatter) /*-{
		...
		var retval = function (el, cellval, opts) {
			var hashMap =  swapthis.@id.co.sigma.jquery.client.grid.cols.BaseColumnDefinition::indexedGridDataByRowId;
			var objPOJO =  hashMap.@java.util.HashMap::get(Ljava/lang/Object;)(cellval.rowId);
			return actualFormatter.@id.co.sigma.jquery.client.grid.CustomFormatter::format(Ljava/lang/Object;)(objPOJO);
		}
