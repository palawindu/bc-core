...
public abstract class BaseJqueryWidget extends Widget{
	...
	protected void onAttach() {
		...
		//FIXME: on detach belum di handle
	...
	//protected  native void renderJQueryWidget(String widgetId, String jqueryClassname)/*-{
	//	var selector= "#" +widgetId;
	//	$wnd.$(selector)[jqueryClassname](this.@id.co.sigma.jquery.client.BaseJqueryWidget::widgetConstructArgument);
	//	this.@id.co.sigma.jquery.client.BaseJqueryWidget::jqueryRendered= true ;
	//}-*/;
	...
	//protected native boolean triggerBooleanReturnMethod (String controlId , String jqueryObjectName , String methodName)/*-{
	...
	//protected native JsDate triggerDateReturnMethod (String controlId , String jqueryObjectName , String methodName)/*-{
	//	return $wnd.$("#" + controlId)[jqueryObjectName](methodName);
	//}-*/;
	...
	//protected native void triggerOption (String controlId , String jqueryObjectName , String optionName , Object optionValue)/*-{
	//	this.@id.co.sigma.jquery.client.BaseJqueryWidget::widgetConstructArgument["optionName"]  = optionValue ;
	...
	//protected native boolean triggerOptionReturnBoolean (String controlId , String jqueryObjectName , String optionName )/*-{
