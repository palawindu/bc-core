...
public abstract class JQBaseAutoComplete<DATA> extends ValueBoxBase<DATA> implements BaseFormElement{
	...
	public native void search () /*-{
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::search();
	}-*/;
	...
	public native void close () /*-{
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::close();
	}-*/;
	...
	protected native void buildChangeEventWire () /*-{
		...
		var evtHandler = function (event, ui) {
			swapThis.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::propagateChangeEvent();
		};
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::autocompleteArg["change"] = evtHandler ; 
	}-*/;
	...
	protected native void resetArray()/*-{
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::dataSource=[];
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::autocompleteArg["source"] =this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::dataSource ;  
	}-*/;
	...
	protected native void putToArray (String value)/*-{
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::dataSource.push(value); 
	}-*/;
	...
	protected native void triggerOption (String widgetId , String optionName , Object optionArgument ) /*-{
		...
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::autocompleteArg[optionName] = optionArgument ;
	...
	protected native void renderAutoComplete ()/*-{
		...
		try{
			...
			$wnd.$("#" +this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::elementId ).autocomplete(
				this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::autocompleteArg 
			);	
		}
		catch(exc){
		}		
	...
	protected native void setStringValue(String valueForWidget)/*-{
		var elemId  = "#" +  this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::elementId ; 
	...
	protected native String getStringValue()/*-{
		return $wnd.$( "#" +  this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::elementId ).val() ; 
	...
	protected native void putDummyLOVSource () /*-{
		this.@id.co.sigma.jquery.client.form.JQBaseAutoComplete::autocompleteArg["source"] ;
