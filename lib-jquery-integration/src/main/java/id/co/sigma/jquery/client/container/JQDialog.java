package id.co.sigma.jquery.client.container;
...
import id.co.sigma.common.form.CloseablePanel;
...
public class JQDialog implements CloseablePanel , DisposeablePanel{
	...
	public native void moveToTop()/*-{
		var dlgId = this.@id.co.sigma.jquery.client.container.JQDialog::dialogId ;
	...
	private native void appendButtonWorker (int idButton ,  String buttonLabel , String buttonDomId )/*-{
		...
		retval["click"] = function (){
			thisSwap.@id.co.sigma.jquery.client.container.JQDialog::propagateExecutor(I)(idButton);
		} ;
		retval["buttonIndexer"]= idButton ;
		this.@id.co.sigma.jquery.client.container.JQDialog::buttonsArray.push( retval ) ; 
	...
	public native void removeButtonWorker (int buttonIdIndexer) /*-{
		var arr = this.@id.co.sigma.jquery.client.container.JQDialog::buttonsArray ;
		var swap = [];
		...
		this.@id.co.sigma.jquery.client.container.JQDialog::buttonsArray  = swap;
	...
	private native void setOption (String option , Object argument) /*-{
		this.@id.co.sigma.jquery.client.container.JQDialog::dialogArgument[option]=argument;
	...
	private native void removeOption (String option ) /*-{
		delete this.@id.co.sigma.jquery.client.container.JQDialog::dialogArgument[option];
	}-*/;


	@Override
	public native void close() /*-{
		$wnd.$("#" +  this.@id.co.sigma.jquery.client.container.JQDialog::dialogId).dialog("close") ;
	}-*/;
	...
	private native void destroy() /*-{
		$wnd.$("#" +  this.@id.co.sigma.jquery.client.container.JQDialog::dialogId).dialog("destroy") ;
	}-*/;
	...
	private native void showDialogWorker () /*-{
		...
		try{
			...
			this.@id.co.sigma.jquery.client.container.JQDialog::dialogArgument["buttons"]=this.@id.co.sigma.jquery.client.container.JQDialog::buttonsArray ;
		
			$wnd.$("#" +  this.@id.co.sigma.jquery.client.container.JQDialog::dialogId).dialog(
			this.@id.co.sigma.jquery.client.container.JQDialog::dialogArgument 
		) ;
		}catch (exc){
