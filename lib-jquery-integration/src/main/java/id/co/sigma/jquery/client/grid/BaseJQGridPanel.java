package id.co.sigma.jquery.client.grid;
...
import id.co.sigma.jquery.client.SimpleDataFilter;
...
import id.co.sigma.jquery.client.grid.cols.HaveSubWidgetColumnDefintion;
import id.co.sigma.jquery.client.grid.cols.ReplaceLabelWorker;
...
import id.co.sigma.jquery.client.grid.event.GridSelectAllHandler;
...
public abstract class BaseJQGridPanel<DATA> extends SimplePanel {
	...
	protected native JavaScriptObject buildSelectRowHandlerGlueMethod ()/*-{
		...
		return function (rowid){
			...
			swapThis.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::propagateRowSelectEvent(Ljava/lang/String;)(rowid);
		}
	...
	protected native JavaScriptObject buildSortChangeEventHandlerGlueMethod()/*-{
		...
		return function (index, colindex, sortorder){
			try{
				swapThis.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::propagateSortChange(Ljava/lang/String;ILjava/lang/String;)(index, colindex, sortorder);
			}
			catch (e) {
	...
	protected native JavaScriptObject buildSelectDoubleClickHandlerGlueMethod ()/*-{
		...
		return function (rowid){
			...
			swapThis.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::propagateRowDoubleClickEvent(Ljava/lang/String;)(rowid);
		}
	}-*/;
	...
	protected native JavaScriptObject buildSelectAllHandlerGlueMethod()/*-{
		...
		return function (rowidArray){
			...
			swapThis.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::propagateSelectAllEventHandler(Ljava/lang/String;)(rowidArray+"");
		}
	...
	protected native JavaScriptObject buildOnResizeEndGlueMethod()/*-{
		...
		return function ( width,  index ){
			swapThis.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::onColumnResizedRaw(Ljava/lang/String;)( width +":"+ index +"" );
		}
	}-*/;
	...
	private native void registerRadioButtonClickHandler( String functionName ) /*-{
		var swapThis = this ;
		var stringPrefix = this.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::radioClickHandlerMethodName ; 
		$wnd[functionName] = function (radioPrefix ) {
			var util = @id.co.sigma.jquery.client.util.JQueryUtils::getInstance()();
			if ( util==null) {
				alert("util nya null"); 
			}
			util.@id.co.sigma.jquery.client.util.JQueryUtils::triggerBridgeMethod(Ljava/lang/String;)( stringPrefix + radioPrefix); 
	...
	private native void registerCheckboxClickHandler( String functionName ) /*-{
		var swapThis = this ;
		var stringPrefix = this.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::checkboxClickHandlerMethodName ;
		
		$wnd[functionName] = function (checkPrefix ) {
			var util = @id.co.sigma.jquery.client.util.JQueryUtils::getInstance()();
			
			util.@id.co.sigma.jquery.client.util.JQueryUtils::triggerBridgeMethod(Ljava/lang/String;)(stringPrefix + checkPrefix); 
		}
	...
	protected native void putCellButtonClickHandler(String gridReferenceMapName, String methodName )/*-{
		...
		var mthd = function(dataRowId ){
			...
			grid.@id.co.sigma.jquery.client.grid.BaseJQGridPanel::triggerCellButtonClickHandler(Ljava/lang/String;Ljava/lang/String;)(dataRowId,methodName);
		};
